...
class RegionPerturbationThreshold(Metric):
    """
    ...
    def __call__(
        ...
        **kwargs,
        ...
        for sample, (x, y, a) in iterator:
            ...
            for th in np.linspace(self.max_heatmap_val, self.min_heatmap_val, num=self.regions_evaluation):
                for i in range(mask.shape[0]):
                    mask[i] = a > th
                x_perturbed = baseline_replacement_by_mask(x, mask)
